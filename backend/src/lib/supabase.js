...
if (!supabaseUrl || (!supabaseAnonKey && !supabaseServiceKey)) {
  ...
  if (!supabaseAnonKey && !supabaseServiceKey) console.error('  - SUPABASE_ANON_KEY and SUPABASE_SERVICE_ROLE_KEY are not defined');
  process.exit(1);
}
...
// Prefer service role key on server for authorized operations
