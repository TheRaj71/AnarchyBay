...
export default function AboutPage() {
  return (
    <div className="min-h-screen">
      ...
      <div className="pt-20 px-8 pb-12 mx-8 my-8 border-4 border-black">
        <div className="excerpt max-w-none">
          <div className="title__container text-center mb-16">
            <h1 className="title__first text-4xl italic font-light mt-12 mb-0 pl-8 text-left">Mrs.</h1>
            <h1 className="title__second text-8xl font-light text-left">Dalloway</h1>
            <img 
              className="flower float-right -mr-44 h-[33rem] shape-outside-flower"
              src="https://raw.githubusercontent.com/melipi/img-repo/main/flower-silhouette.png"
              alt="flower silhouette"
            />
            <h2 className="text-xl leading-8 italic mt-4">by Virginia Woolf</h2>
            <h3 className="w-60 mx-auto my-12 py-2 text-2xl leading-8 font-normal italic border-t-[0.15rem] border-b-[0.15rem] border-black">
              An Excerpt from Chapter One
            </h3>
          </div>

          <div className="columns-[22rem] gap-6">
            <p className="text-justify my-4 leading-6 first-letter:font-['Fleur_De_Leah',cursive] first-letter:text-5xl first-letter:p-1 first-letter:float-left first-letter:mr-1 first-letter:mt-[-1rem] first-letter:mb-[-0.25rem] text-xl leading-8 italic mb-8">
              Mrs. Dalloway said she would buy the flowers herself.
            </p>

            <p className="text-justify my-4 leading-6">
