...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      <div className="absolute top-10 left-10 w-24 h-24 bg-[var(--pink-300)] border-3 border-black rotate-12 hidden lg:block" />
      <div className="absolute bottom-10 right-10 w-32 h-32 bg-[var(--yellow-400)] border-3 border-black -rotate-6 hidden lg:block" />
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="bg-white border-3 border-black shadow-[8px_8px_0px_var(--black)] p-8">
          ...
          <p className="text-center mt-6 text-gray-600">
            ...
            <Link to="/signup" className="font-bold text-[var(--pink-600)] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
